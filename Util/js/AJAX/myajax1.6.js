      /*
        ...
        * {Authorization:b,c:d}
        */
        Ajax.prototype.addHeader=function(obj){
          for(var i in obj){
        ...
        Ajax.prototype.removeHeader=function(key){
          delete this.headers[key]
          return this
        }

        Ajax.prototype.removeAllHeader=function(){
          this.headers={}
          return this
        }
        ...
        */
        ...
        var exec=function(opts,middleware,succCallback,failCallback){
          ...
          opts['headers']=myajax.headers
          console.log('test',opts,myajax.headers);
          myajax.$.ajax(opts);
        }
...
myajax.addHeader({
    ...
    }).get('http://sdp.hzsb365.com/api/v1/user/login',{a:123,b:456})*/